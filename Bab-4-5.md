...
Berdasarkan kedua hasil pengujian tersebut, sistem AudioMatch mampu menjawab kedua rumusan masalah penelitian ini. **Tujuan 1** — merancang dan mengembangkan chatbot berbasis RAG dengan Hybrid Search yang mampu menghasilkan respons akurat dan minim halusinasi — terjawab melalui dua bukti teknis: (1) seluruh 9 skenario *Black Box Testing* berhasil dengan status PASS, mengonfirmasi bahwa sistem berfungsi sesuai rancangan dan konsisten menolak kueri di luar domain tanpa menghasilkan informasi yang difabrikasi; (2) nilai NDCG@3 sebesar 0,8100 dan NDCG@5 sebesar 0,8878 menunjukkan bahwa komponen retrieval berhasil menyajikan dokumen paling relevan di posisi teratas, sehingga konteks yang diinjeksikan ke LLM berkualitas tinggi dan risiko halusinasi residual dapat diminimalkan. **Tujuan 2** — mengevaluasi efektivitas sistem — terjawab melalui kombinasi Black Box Testing dan evaluasi kualitas retrieval dengan metrik NDCG@K dan Precision@K yang menghasilkan gambaran performa yang menyeluruh sekaligus mengidentifikasi celah yang perlu ditingkatkan.
