...
Perlu dijelaskan pula mengapa evaluasi pada fase Pengujian **tidak melibatkan pengguna nyata secara langsung**. Penelitian ini berfokus pada verifikasi fungsionalitas dan kualitas pipeline RAG sebagai sistem teknis, bukan pada dimensi pengalaman pengguna atau kepuasan pelanggan. Evaluasi berbasis responden memerlukan desain instrumen yang berbeda — kuesioner kepuasan, skenario pengguna representatif, dan analisis statistik terhadap respons subjektif — yang berada di luar cakupan teknis penelitian ini. Selain itu, keakuratan pipeline RAG (NDCG@K, Precision@K, dan Black Box Testing) merupakan prasyarat teknis yang harus diverifikasi terlebih dahulu sebelum sistem layak diuji di hadapan pengguna nyata. Dengan demikian, pengujian berbasis pengguna merupakan tahap lanjutan yang direkomendasikan setelah sistem teknis tervalidasi, sebagaimana diuraikan dalam Bab 5 bagian Saran.
